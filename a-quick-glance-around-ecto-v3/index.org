...
* Introduction
  ...
  + [[https://hexdocs.pm/ecto/][Ecto's Docs]]
  + [[https://pragprog.com/book/wmecto/programming-ecto][Programming Ecto]]
...
*** build relationship between authors and posts (1-N)
    As we said above:
...
** Available column types
   ...
   + map =:string= to [[https://github.com/elixir-ecto/ecto_sql/blob/eda193965ef112cd0e8f584c58a2efa751655a3e/lib/ecto/adapters/postgres/connection.ex#L1066][=:varchar(255)=]]
   + map =:binary= to =:bytea=
   + ...
...
** Note for =cast= / =cast_assoc= / =put_assoc= / =build_assoc=
   ...
   [[file:./assets/73d21fd0fd4e3fd9989c9bd280b6a3ec.png]]

   Pic from [[https://web.archive.org/web/20210110052704/https://blog.appsignal.com/2020/11/10/understanding-associations-in-elixir-ecto.html][Understanding Associations in Elixir's Ecto]]
...
** About using UUID as id globally
   #+begin_quote
   ...
   -- Summarized from [[https://web.archive.org/web/20210109133524/https://www.honeybadger.io/blog/easy-rails-database-scaling-wins/][Simple tips to make scaling your database easier as you grow]]
   #+end_quote
   ...
   References:
   + [[https://web.archive.org/web/20210109134825/https://www.annkissam.com/elixir/alembic/posts/2019/01/04/ecto-and-binary-ids.html][Ecto and Binary IDs]]

   By default, the UUID is generated by Elixir, if you want to generate UUID by database, read [[https://web.archive.org/web/20210109141700/https://www.swwritings.com/post/2019-01-11-ecto-and-binary-ids-generated-by-postgresql][Ecto and Binary IDs Generated By PostgreSQL]].

** About using enum in Ecto
   References:
   + [[https://web.archive.org/web/20210109014356/https://dennisbeatty.com/use-the-new-enum-type-in-ecto-3-5.html][Use the new Enum type in Ecto 3.5]]

*** method 1 - use builtin feature
...
*** method 2 - use [[https://github.com/gjaldon/ecto_enum][EctoEnum]]
    #+begin_src elixir
